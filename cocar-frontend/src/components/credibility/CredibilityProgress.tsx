...
export const CredibilityProgress: React.FC<CredibilityProgressProps> = ({
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100">
        ...
        {progress.max_level && (
          <div className="text-center">
            <p className="text-xs font-semibold text-purple-600 flex items-center justify-center gap-1">
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-gray-600">Points de crédibilité</span>
